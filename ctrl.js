...
.controller('nameController', ['$scope', function($scope) {
  ...
  $scope.moder = function() {
    BootstrapDialog.show({
            ...
            message: 'To use, click on one of the categories and then select whatever fits your planet. In some cases, multiple can be selected. <br><br>The planet names are based off of <a href="https://i.redd.it/pfanhavkwvcx.jpg">this encoder</a>. Enjoy! <br><br>Written by <a href="https://github.com/NCarteazy/NCarteazy.github.io">Nicholas Carter</a>.<br><br>Let me know any feedback by messaging me on Reddit: <a href="https://www.reddit.com/user/carteazy">/u/Carteazy</a>',
            cssClass: 'posmodal',
            closable: true
        });
  }
